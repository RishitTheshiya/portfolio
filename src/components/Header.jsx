export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-[outfit]">frontend web developer </h1>
            <p className="max-w-2xl mx-auto font-[outfit]">Passionate Frontend Web Developer focused on crafting interactive, user-centric interfaces. Dedicated to writing clean code and building seamless digital experiences.</p>
